...
filedata = filedata.replace('</head>', '<style>body{font-family:monospace;text-align:center;color:#111}hr{border:none;border-bottom:1px solid #aaa;height:0;max-width:320px;margin:16px auto 8px}div.p{font-size:.8em;color:#aaa}div.p a{color:#777;text-decoration:none}</style><link rel=\\"shortcut icon\\" type=\\"image/gif\\" href=\\"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==\\"></head>')
